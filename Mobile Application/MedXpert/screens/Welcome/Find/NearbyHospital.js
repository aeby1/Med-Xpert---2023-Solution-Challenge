...
const NearbyHospital = () => {
  ...
  const [HospitalsNearMe, setHospitalsNearMe] = useState([])
      ...
      axios
        ...
        .then(function (response) {
          ...
          for (var i = 0; i < APIData.length; i++) {
            ...
            NewObj['place_id'] = APIData[i]['place_id']
            NewObj["address"] = APIData[i]["vicinity"];
            TempArr = [...TempArr, NewObj]
          }
          setHospitalsNearMe(TempArr)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.AvailablePharmacy}>
          ...
          <FlatList
            data={HospitalsNearMe && HospitalsNearMe}
            renderItem={({ item }) => (
          ...
          />
            ...
            <View>
              <Text style={{ fontSize: 12 }}>
                We are fetching hospitals near you. Please Wait.👋
              </Text>
            </View>
          </View>
      )}
